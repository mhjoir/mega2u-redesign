            ...
            <div className="flex items-center gap-1 sm:gap-2 mr-auto">
              ...
              <div className="relative" ref={accountRef}>
                <button
                  ...
                  className="flex items-center gap-1.5 px-2 sm:px-3 h-10 rounded-xl text-[#011627] hover:bg-[#f5f6fa] transition-colors"
                  aria-label="حسابي"
                >
                  <User className="w-5 h-5" />
                  <span className="hidden lg:inline text-sm font-bold">حسابي</span>
                  <ChevronDown
                    className={`hidden lg:inline w-4 h-4 transition-transform ${
                ...
                {showAccountMenu && (
                  <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-[#e7eaf3] overflow-hidden animate-in fade-in slide-in-from-top-2">
                    <div className="p-4 bg-gradient-to-l from-[#ff6b35]/5 to-transparent border-b border-[#e7eaf3]">
                      <p className="font-black text-[#011627] text-sm">
                        أهلاً بك في MEGA2U
                      </p>
                      <p className="text-xs text-gray-500 mt-0.5">
                        سجّل دخولك للوصول إلى طلباتك
                      </p>
                    </div>
                    ...
                    <div className="border-t border-[#e7eaf3]">
                      <button
                        ...
                        className="w-full text-right px-4 py-3 text-sm font-bold text-[#011627] hover:bg-[#f5f6fa] transition-colors flex items-center justify-between"
                      >
                        <span>منطقة العملاء</span>
                      ...
                      <button
                        ...
                        className="w-full text-right px-4 py-3 text-sm font-bold text-[#011627] hover:bg-[#f5f6fa] transition-colors flex items-center justify-between border-t border-[#e7eaf3]"
                      >
                        <span>طلباتي</span>
                        <ChevronLeft className="w-4 h-4" />
                      </button>
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 h-10 rounded-xl bg-[#011627] text-white hover:bg-[#0f3460] transition-colors relative"
                aria-label="سلة التسوق"
              >
                <ShoppingCart className="w-5 h-5" />
                <span className="hidden sm:inline text-sm font-bold">السلة</span>
                <span className="absolute -top-1 -left-1 w-5 h-5 bg-[#ff6b35] text-white text-[10px] font-black rounded-full flex items-center justify-center border-2 border-white">
                  0
                </span>
              </button>
